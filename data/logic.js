...
function uiUpdate(cmd){
    switch(uiState){
        case '-view':
            ...
            style.setProperty('--header-bg','none')
        ...
        case '-edit':
            ...
            style.setProperty('--header-bg','var(--section-bg)')
            style.setProperty('--edit-btn-color','white')
            style.setProperty('--slide-highlight','0px 0px 0px 3px var(--light-accent)')
            style.setProperty('--slide-highlight-active','0px 0px 0px 3px var(--light-accent) ')
